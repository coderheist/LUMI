 ...
 *
 * The content only, with no Section wrapper — used by Knowledge.tsx to fold
 * this into a shared section on the homepage. `<Integrations>` below is the
 * standalone version /integrations still uses on its own.
 */

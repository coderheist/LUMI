...
/**
 * The content only, with no Section wrapper — used by Discovery.tsx to fold
 * this into a shared section on the homepage. `<Channels>` below is the
 * standalone version /features still uses on its own.
 */
